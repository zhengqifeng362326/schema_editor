...
import { useTreeNode, useNodeIdProps, TreeNodeWidget, DroppableWidget, DnFC } from '@designable/react';
        ...
        {panels.map((panel) => {
          ...
          return (
            <Collapse.Panel
              ...
              style={{ ...props.style }}
              title={
                <span data-content-editable="x-component-props.title" data-content-editable-node-id={panel.id}>
                  {props.title}
                </span>
              }
              key={panel.id}
