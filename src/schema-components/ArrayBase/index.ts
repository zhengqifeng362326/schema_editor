...
export const createArrayBehavior = (name: string) => {
  return createBehavior(
    ...
    },
    {
      name: `${name}.Addition`,
      extends: ['Field'],
      selector: (node: any) => node?.props?.['x-component'] === `${name}.Addition`,
      designerProps: {
        allowDrop(parent: any) {
    ...
    },
    {
      name: `${name}.Remove`,
      extends: ['Field'],
      selector: (node: any) => node?.props?.['x-component'] === `${name}.Remove`,
      designerProps: {
        allowDrop(parent: any) {
          return parent.props['x-component'] === name;
        },
    ...
    },
    {
      name: `${name}.Index`,
      extends: ['Field'],
      selector: (node: any) => node?.props?.['x-component'] === `${name}.Index`,
      designerProps: {
        allowDrop(parent: any) {
          return parent.props['x-component'] === name;
        },
    ...
    },
    {
      name: `${name}.MoveUp`,
      extends: ['Field'],
      selector: (node: any) => node?.props?.['x-component'] === `${name}.MoveUp`,
      designerProps: {
        allowDrop(parent: any) {
          return parent.props['x-component'] === name;
        },
    ...
    },
    {
      name: `${name}.MoveDown`,
      extends: ['Field'],
      selector: (node: any) => node?.props?.['x-component'] === `${name}.MoveDown`,
      designerProps: {
        allowDrop(parent: any) {
